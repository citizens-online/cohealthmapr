...
Each surgery is colour-coded according to the number of people aged 65+ on its register (<span style="color: `r viridisLite::viridis(n = 5)[[1]]`;">**purple**</span> means the surgery is in the top or "oldest" quintile (20%) of surgeries by age; <span style="color: `r viridisLite::viridis(n = 5)[[5]]`; background-color: #bfbfbf;">**yellow**</span> means it is one of the 20% "youngest" (least people aged 65+)).
...
```{r tmap, eval = FALSE, echo = FALSE, out.width="100%", out.height = "600px"}
