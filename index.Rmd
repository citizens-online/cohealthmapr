...
full_data_sf %>% 
  ...
  leaflet::addCircles(
    ...
    popup = paste0(
      "<h3>", full_data_under70$practice_name, "</h3>",
      "Postcode: ", full_data_under70$postcode, "<br />",
      "Total number of patients: ", full_data_under70$total_patients, "<br />",
      "Number of patients aged 65+: ", full_data_under70$older_popn_unwtd, "<br />",
      "% patients not registered for an online service: ", full_data_under70$offline_pat_pct, "%<br />",
      "Online transactions in Feb 2020: ", full_data_under70$total_use)) %>% 
  leaflet::addCircles(
    ...
    popup = paste0(
      "<h3>", full_data_over70$practice_name, "</h3>",
      "Postcode: ", full_data_over70$postcode, "<br />",
      "Total number of patients: ", full_data_over70$total_patients, "<br />",
      "Number of patients aged 65+: ", full_data_over70$older_popn_unwtd, "<br />",
      "% patients not registered for an online service: ", full_data_over70$offline_pat_pct, "%<br />",
      "Online transactions in Feb 2020: ", full_data_over70$total_use)) %>% 
  ...
  addLegend(
    position = "topright",
    colors = viridisLite::viridis(5, direction = -1),
    opacity = 0.75,
